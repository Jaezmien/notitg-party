...
function PartyLobbyPrevious()
	Lemonade:Send(2, {1, 1}) -- Send to the client that we've left the lobby via previous screen
	return "ScreenTitleMenu"
end

function PartyRoomPrevious()
	Lemonade:Send(2, {2, 1}) -- Send to the client that we're moving back to the lobby screen
	return "ScreenPartyLobby"
end
